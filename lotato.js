...
function showBetForm(gameType) {
    ...
    document.getElementById('games-interface').style.display = 'block';
    const autoButtonsEl = document.getElementById('auto-buttons');
    if (autoButtonsEl) autoButtonsEl.style.display = 'none';
...
function showAutoGameForm(gameType) {
    const bet = betTypes[gameType];
    document.getElementById('games-interface').style.display = 'block';
    const autoButtonsEl2 = document.getElementById('auto-buttons');
    if (autoButtonsEl2) autoButtonsEl2.style.display = 'none';
    const betForm = document.getElementById('bet-form');
    betForm.style.display = 'block';
    selectedBalls = [];
    let formHTML = '';
